...
- [Abnormal login behavior](User&Entity-Behavior-Analytics(UEBA)/ 
- [Rare command execution](User&Entity-Behavior-Analytics(UEBA)/ 
- [Off-hours activity detection](User&Entity-Behavior-Analytics(UEBA)/  
